import type { CalibreBook, createCalibreClient } from "../client";

// TODO: The Db type references agent's initDb. Will import from a shared package once
// the DB layer is extracted from the agent.
type Db = ReturnType<typeof import("../../../agent/src/services/db").initDb>;
type Calibre = ReturnType<typeof createCalibreClient>;

// Drizzle imports from the agent schema — will move to plugin schema once extracted
